...
export default function ContactForm({
  ...
  subheadline = "Questions about classes, memberships, or scheduling? We are ready.",
  contactInfo = [
    { icon: "Phone", label: "Call Us", value: "(555) 246-9012" },
    { icon: "Mail", label: "Email", value: "hello@ignitefitness.com" },
    { icon: "MapPin", label: "Visit", value: "88 Forge Ave, Downtown" },
    { icon: "Clock", label: "Hours", value: "Mon–Sat 5am–10pm" },
  ],
